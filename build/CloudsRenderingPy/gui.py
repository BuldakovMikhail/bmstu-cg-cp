...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(1280, 716))
        ...
        self.densitySB = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.densitySB.setMaximum(200.0)
        self.densitySB.setProperty("value", 50.0)
        self.densitySB.setObjectName("densitySB")
        self.verticalLayout_2.addWidget(self.densitySB)
        self.label_5 = QtWidgets.QLabel(self.groupBox)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_2.addWidget(self.label_5)
        self.coverageSB = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.coverageSB.setMaximum(2.0)
        self.coverageSB.setProperty("value", 1.2)
        self.coverageSB.setObjectName("coverageSB")
        self.verticalLayout_2.addWidget(self.coverageSB)
        self.label_6 = QtWidgets.QLabel(self.groupBox)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_2.addWidget(self.label_6)
        self.eccentrisySB = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.eccentrisySB.setDecimals(5)
        self.eccentrisySB.setMaximum(0.99999)
        self.eccentrisySB.setSingleStep(0.1)
        self.eccentrisySB.setProperty("value", 0.49)
        self.eccentrisySB.setObjectName("eccentrisySB")
        self.verticalLayout_2.addWidget(self.eccentrisySB)
